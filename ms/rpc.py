...
class Lobby(MSRPCService):
    ...
    _req = {
        ...
        'amuletActivityFetchInfo': pb.ReqAmuletActivityFetchInfo,
        ...
        'amuletActivityChangeHands': pb.ReqAmuletActivityChangeHands,
        ...
        'amuletActivityReceiveTaskReward': pb.ReqAmuletActivityReceiveTaskReward,
    ...
    _res = {
        ...
        'amuletActivityFetchInfo': pb.ResAmuletActivityFetchInfo,
        'amuletActivityFetchBrief': pb.ResAmuletActivityFetchBrief,
        'amuletActivityStartGame': pb.ResAmuletActivityStartGame,
        'amuletActivityOperate': pb.ResAmuletActivityOperate,
        'amuletActivityChangeHands': pb.ResAmuletActivityChangeHands,
        'amuletActivityUpgrade': pb.ResAmuletActivityUpgrade,
        'amuletActivityBuy': pb.ResAmuletActivityBuy,
        'amuletActivitySelectPack': pb.ResAmuletActivitySelectPack,
        'amuletActivitySellEffect': pb.ResAmuletActivitySellEffect,
        'amuletActivityEffectSort': pb.ResCommon,
        'amuletActivityGiveup': pb.ResCommon,
        'amuletActivityRefreshShop': pb.ResAmuletActivityRefreshShop,
        'amuletActivitySelectFreeEffect': pb.ResAmuletActivitySelectFreeEffect,
        'amuletActivityUpgradeShopBuff': pb.ResAmuletActivityUpgradeShopBuff,
        'amuletActivityEndShopping': pb.ResAmuletActivityEndShopping,
        'amuletActivitySetSkillLevel': pb.ResCommon,
        'amuletActivityMaintainInfo': pb.ResAmuletActivityMaintainInfo,
        'amuletActivitySelectRewardPack': pb.ResAmuletActivitySelectRewardPack,
        'amuletActivityReceiveTaskReward': pb.ResAmuletActivityReceiveTaskReward,
    ...
    async def amulet_activity_fetch_info(self, req):
        return await self.call_method('amuletActivityFetchInfo', req)
    ...
    async def amulet_activity_change_hands(self, req):
        return await self.call_method('amuletActivityChangeHands', req)
    ...
    async def amulet_activity_receive_task_reward(self, req):
        return await self.call_method('amuletActivityReceiveTaskReward', req)
